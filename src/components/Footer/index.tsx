function Footer() {
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Termos de uso</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Informações de entrega</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Formas de pagamento</a>
        </p>
        <p>
          <a href="#!" className="text-gray-600">Como comprar</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <a className="text-gray-600 font-semibold" href="https://helioanacronista.github.io/HelioAnacronista.io/">HelioAnacronista.io</a>
  </div>
</footer>
